...
namespace NQueen.Test
{
    public class TestBase
    {
        ...
        {
            var result = (solutionMode == SolutionMode.Single)
        ...
        {
            return Sut.GetSimulationResultsAsync(boardSize, solutionMode)
                    .Result
                    .Solutions
        ...
        public static List<sbyte[]> GetSingleSol(sbyte boardSize)
        {
            return singleSol[boardSize];
        }

        public static List<sbyte[]> GetUniqueSols(sbyte boardSize)
        {
            return uniqueSol[boardSize];
        }

        public static List<sbyte[]> GetAllSols(sbyte boardSize)
        {
        ...
        private static readonly Dictionary<sbyte, List<sbyte[]>> singleSol = new Dictionary<sbyte, List<sbyte[]>>
        {
            ...
            { 2, new List<sbyte[]> { new sbyte[] { } } },
            { 3, new List<sbyte[]> { new sbyte[] { 0 } } },
            ...
            { 22, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 9, 13, 16, 19, 12, 18, 21, 17, 7, 20, 11, 8, 5,
                    15, 6, 10, 14 } } },

            { 23, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 8, 10, 12, 17, 19, 21, 18, 20, 9, 7, 5, 22, 6,
                    15, 11, 14, 16, 13 }  } },

            { 24, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 8, 10, 13, 17, 21, 18, 22, 19, 23, 9, 20, 5, 7,
                    11, 15, 12, 6, 16, 14 } } },

            { 25, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 8, 10, 12, 14, 18, 20, 23, 19, 24, 22, 5, 7, 9,
                    6, 13, 15, 17, 11, 16, 21} }  },

            { 26, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 8, 10, 12, 14, 20, 22, 24, 19, 21, 23, 25, 9, 6,
                    15, 11, 7, 5, 17, 13, 18, 16} } },

            { 27, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 8, 10, 12, 14, 16, 18, 22, 24, 26, 23, 25, 5, 9,
                    6, 15, 7, 11, 13, 20, 17, 19, 21 } } },

            { 28, new List<sbyte[]> { new sbyte[] {0, 2, 4, 1, 3, 8, 10, 12, 14, 16, 22, 24, 21, 27, 25, 23, 26, 6,
